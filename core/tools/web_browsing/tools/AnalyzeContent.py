...
@dataclass
class AnalyzeContentResult(ToolResult):
    screenshot_path: str = ""
    analysis_text: str = ""

class AnalyzeContent(Tool):
    """
    ...
    def run(self) -> AnalyzeContentResult:
        wd = get_web_driver()
        ...
        return AnalyzeContentResult(success=True, exit_code=0, output=message_text, screenshot_path=screenshot_path)
